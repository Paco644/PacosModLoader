...
public class PacosModLoader : BaseUnityPlugin
{
    public static PacosModLoader Instance { get; private set; }
    ...
    void Awake()
    {
        ...
        _harmony.PatchAll(typeof(global::PacosModLoader.Patches.GeneralUiScriptStartPatch));
